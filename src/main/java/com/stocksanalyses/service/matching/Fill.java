...
public class Fill {
  ...
  public Fill(String tradeId, String takerOrderId, String makerOrderId, long price, long quantity, long timestamp, Side takerSide, List<Fee> fees) {
  ...
  public Fill(String tradeId, String takerOrderId, String makerOrderId, long price, long quantity, long timestamp, Side takerSide, List<Fee> fees, String orderId) {
    this.tradeId = tradeId;
    this.takerOrderId = takerOrderId;
    this.makerOrderId = makerOrderId;
    this.price = price;
